...
<div class="container">
	...
	<table class="table table-striped">
		...
		foreach($data as $row){ ?>
			...
			<!-- action btn -->
			<td width="30%"><a href='' onclick="return(confirm('voulez vous vraiment modifier'))" class='btn btn-primary'>modifier</a>&nbsp;<a href='' class='btn btn-danger' onclick="return(confirm('voulez vous vraiment supprimer <?php echo $row['username'];?>'))">supprimer</a></td>
			</tr>
 	<?php } ;?>
